...
{
    return sGuildMgr.GetGuildById(member->GetGuildId())->GetMemberSlot(member->GetObjectGuid())->RankId;
}

bool GuildInviteAction::isUseful()
{
    return bot->GetGuildId() && sGuildMgr.GetGuildById(bot->GetGuildId())->HasRankRight(bot->GetRank(), GR_RIGHT_INVITE);
}

void GuildInviteAction::SendPacket(WorldPacket data) override
{
    bot->GetSession()->HandleGuildInviteOpcode(data);
}

bool GuildInviteAction::PlayerIsValid(Player* member) override
{
    return !member->GetGuildId();
}
...
{
    return bot->GetGuildId() && sGuildMgr.GetGuildById(bot->GetGuildId())->HasRankRight(bot->GetRank(), GR_RIGHT_PROMOTE);
}

void GuildPromoteAction::SendPacket(WorldPacket data)
{
...
{
    return bot->GetGuildId() && sGuildMgr.GetGuildById(bot->GetGuildId())->HasRankRight(bot->GetRank(), GR_RIGHT_DEMOTE);
}

void GuildDemoteAction::SendPacket(WorldPacket data)
{
...
{
    return bot->GetGuildId() && sGuildMgr.GetGuildById(bot->GetGuildId())->HasRankRight(bot->GetRank(), GR_RIGHT_REMOVE);
}

void GuildRemoveAction::SendPacket(WorldPacket data)
{
